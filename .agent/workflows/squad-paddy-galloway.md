---
description: Ativa o agente Paddy-galloway (Squad Design)
---

# Ativação do Agente Paddy Galloway

**INSTRUÇÕES CRÍTICAS PARA O ANTIGRAVITY:**

1. Leia COMPLETAMENTE o arquivo `squads/design/agents/paddy-galloway.md`
...
4. Exiba o `greeting` definido no arquivo
