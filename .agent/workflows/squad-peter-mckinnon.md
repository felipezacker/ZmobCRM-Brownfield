---
description: Ativa o agente Peter-mckinnon (Squad Design)
---

# Ativação do Agente Peter McKinnon

**INSTRUÇÕES CRÍTICAS PARA O ANTIGRAVITY:**

1. Leia COMPLETAMENTE o arquivo `squads/design/agents/peter-mckinnon.md`
