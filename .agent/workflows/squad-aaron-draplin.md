---
description: Ativa o agente Aaron-draplin (Squad Design)
---

# Ativação do Agente Aaron Draplin

**INSTRUÇÕES CRÍTICAS PARA O ANTIGRAVITY:**

1. Leia COMPLETAMENTE o arquivo `squads/design/agents/aaron-draplin.md`
