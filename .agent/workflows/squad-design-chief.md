---
description: Ativa o agente Design-chief (Squad Design)
---

# Ativação do Agente Design Chief

**INSTRUÇÕES CRÍTICAS PARA O ANTIGRAVITY:**

1. Leia COMPLETAMENTE o arquivo `squads/design/agents/design-chief.md`
