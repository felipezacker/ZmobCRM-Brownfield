...
export const PeriodFilterSelect: React.FC<PeriodFilterSelectProps> = ({
    ...
    return (
        <select
            ...
            className={`px-3 py-2 bg-white dark:bg-card border border-border dark:border-border rounded-lg text-sm font-medium text-secondary-foreground dark:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary-500 ${className}`}
        >
