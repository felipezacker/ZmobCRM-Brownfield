...
export const MODAL_PANEL_BASE_CLASS =
  'bg-card dark:bg-dark-card border border-border  shadow-2xl w-full flex flex-col overflow-hidden rounded-xl sm:rounded-2xl';
...
export const MODAL_HEADER_CLASS =
  'p-3 sm:p-4 border-b border-border  flex items-center justify-between shrink-0';
...
export const MODAL_FOOTER_CLASS =
  'p-4 sm:p-5 border-t border-border  bg-card dark:bg-dark-card shrink-0';
