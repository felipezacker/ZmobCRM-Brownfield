      ...
      <div className="relative w-full max-w-3xl mx-4 rounded-2xl border border-white/10 bg-background shadow-2xl overflow-hidden">
        <div className="flex items-center justify-between gap-3 border-b border-white/10 px-4 py-3">
          <div className="min-w-0">
            ...
            <div className="text-1xs text-muted-foreground">Escolha um script persistido e eu preencho a mensagem com vari\u00e1veis do deal/contato.</div>
          </div>
          <Button
            type="button"
                ...
                {categories.map((c) => (
                  <Button
                    ...
                    className={category === c.key
                      ? 'rounded-full bg-cyan-500/15 text-cyan-200 ring-1 ring-cyan-500/20 px-2.5 py-1 text-1xs font-semibold'
                      : 'rounded-full bg-white/5 text-muted-foreground ring-1 ring-white/10 px-2.5 py-1 text-1xs font-semibold hover:bg-white/10'
                    }
                  >
                    {c.label}
                  </Button>
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center justify-between gap-3">
                          ...
                          <div className="shrink-0 text-1xs font-semibold text-cyan-200">Usar</div>
                        </div>
                      </Button>
                    );
                  })}
