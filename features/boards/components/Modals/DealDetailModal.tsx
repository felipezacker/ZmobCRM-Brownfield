...
export const DealDetailModal: React.FC<DealDetailModalProps> = ({ dealId, isOpen, onClose }) => {
  ...
  const handleAnalyzeDeal = async () => {
    ...
    try {
      ...
      addToast(
        error instanceof Error ? error.message : 'Falha ao analisar deal com IA. Verifique Configurações → Inteligência Artificial.',
        'warning'
      );
    } finally {
  ...
  const handleDraftEmail = async () => {
    ...
    try {
      ...
      addToast(
        error instanceof Error ? error.message : 'Falha ao gerar e-mail com IA. Verifique Configurações → Inteligência Artificial.',
        'warning'
      );
    } finally {
      setIsDrafting(false);
  ...
  const handleObjection = async () => {
    ...
    try {
      ...
      addToast(
        error instanceof Error ? error.message : 'Falha ao gerar respostas. Verifique Configurações → Inteligência Artificial.',
        'warning'
      );
    } finally {
