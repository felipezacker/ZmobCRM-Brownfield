    ...
    <div className="space-y-6">
      ...
      <div
        className={`p-4 rounded-xl border ${
          isChatMode
            ? 'bg-white dark:bg-dark-card border-border  shadow-sm'
      ...
      >
        ...
        <div className="space-y-2">
          {displayBoard.stages.map((stage, idx) => (
            <div
              key={idx}
              className="flex items-center gap-3 p-3 bg-white dark:bg-dark-card rounded-lg border border-border"
            >
              ...
              <div className="flex-1">
                <h5 className="font-semibold text-foreground">{stage.name}</h5>
                <p className="text-xs text-muted-foreground dark:text-muted-foreground">{stage.description}</p>
              </div>
        ...
        {displayBoard.automationSuggestions &&
          displayBoard.automationSuggestions.length > 0 && (
            <div className="mt-4 pt-4 border-t border-border">
              <p className="text-sm font-semibold text-secondary-foreground dark:text-muted-foreground mb-2">
                Automacoes sugeridas:
              </p>
              <ul className="text-sm text-secondary-foreground dark:text-muted-foreground space-y-1">
