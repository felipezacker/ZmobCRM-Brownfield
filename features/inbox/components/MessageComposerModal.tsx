            ...
            <div className="space-y-4">
                <div className="flex items-start gap-3">
                    ...
                    <div className="min-w-0">
                        ...
                        {aiBadge && (
                            <p className="mt-1 text-1xs text-primary-600 dark:text-primary-400 flex items-center gap-1">
                ...
                {channel === 'EMAIL' && (
                    <div className="space-y-2">
                        ...
                        {copied === 'subject' && (
                            <p className="text-1xs text-emerald-600 dark:text-emerald-400">Assunto copiado</p>
                        )}
                    </div>
                )}
