    ...
    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
      ...
      <div className="flex gap-3 w-full sm:w-auto">
        ...
        <Button
          ...
          className={`relative p-2 border rounded-lg transition-colors ${isFilterOpen ? 'bg-primary-50 border-primary-200 text-primary-600' : 'bg-white dark:bg-white/5 border-border dark:border-border text-secondary-foreground dark:text-muted-foreground hover:bg-background dark:hover:bg-white/10'}`}
        >
        ...
        {viewMode === 'people' && (
          <>
            <Button
              ...
              className="p-2 bg-white dark:bg-white/5 border border-border dark:border-border rounded-lg hover:bg-background dark:hover:bg-white/10 text-secondary-foreground dark:text-muted-foreground transition-colors"
            >
